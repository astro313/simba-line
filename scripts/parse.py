...
# Karen's: per halo, blah/snapshots/h0/Groups/caesar_00(snapnum)_zxxx.hdf5 -- from caesar.drive()
# Romeel: all halos, Groups/m25n256_snapnum.hdf5


# ----- looking into load_module.py ----
# for each snapshot, split out the different halos, given in the param file
snapRange = [151]      # snaps_table

# for Simba kind of files, the following should be supplied in an external file.
